...
5. Remember your `IP address`, `Gateway` and `Subnet mask`, then click on the `setting` icon
...
7. Enter your `IP address`, `Gateway`, `Network prefix length` and DNS.SB's servers
