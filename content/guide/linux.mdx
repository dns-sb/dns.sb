...
description: "Step-by-step guide to configure DNS.SB on Linux. Learn how to change DNS settings using resolv.conf or Netplan for faster, more private internet browsing."
---
...
```bash filename="/etc/netplan/01-netcfg.yaml"
network:
    version: 2
    ethernets:
        eth0:
